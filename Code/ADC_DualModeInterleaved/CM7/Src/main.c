...
/* ADC parameters */
#define ADCCONVERTEDVALUES_BUFFER_SIZE ((uint32_t)  1024)	/* Size of array containing ADC converted values */
...
#define WAVEFORM_TEST_SAMPLES_NUMBER                     ((uint32_t)    10)   /* Size of array of DAC waveform samples */
...
__IO uint8_t ubADCDualConversionComplete = RESET; /* Set into ADC conversion complete callback */
...
const uint8_t Waveform_8bits[WAVEFORM_TEST_SAMPLES_NUMBER] = {
	...
	COMPUTATION_VOLTAGE_TO_DIGITAL_8BITS( VDD_APPLI * 1 / (WAVEFORM_TEST_SAMPLES_NUMBER - 1)),    /* Expected voltage: 1/4 of Vdda, corresponding digital values: to  63 on 8 bits and 1023 and 12 bits */
	COMPUTATION_VOLTAGE_TO_DIGITAL_8BITS( VDD_APPLI * 2 / (WAVEFORM_TEST_SAMPLES_NUMBER - 1)),    /* Expected voltage: 1/2 of Vdda, corresponding digital values: to 127 on 8 bits and 2047 and 12 bits */
	COMPUTATION_VOLTAGE_TO_DIGITAL_8BITS( VDD_APPLI * 3 / (WAVEFORM_TEST_SAMPLES_NUMBER - 1)),    /* Expected voltage: 3/4 of Vdda, corresponding digital values: to 191 on 8 bits and 3071 and 12 bits */
	COMPUTATION_VOLTAGE_TO_DIGITAL_8BITS( VDD_APPLI * 4 / (WAVEFORM_TEST_SAMPLES_NUMBER - 1)),
	COMPUTATION_VOLTAGE_TO_DIGITAL_8BITS( VDD_APPLI * 5 / (WAVEFORM_TEST_SAMPLES_NUMBER - 1)),
	COMPUTATION_VOLTAGE_TO_DIGITAL_8BITS( VDD_APPLI * 6 / (WAVEFORM_TEST_SAMPLES_NUMBER - 1)),
	COMPUTATION_VOLTAGE_TO_DIGITAL_8BITS( VDD_APPLI * 7 / (WAVEFORM_TEST_SAMPLES_NUMBER - 1)),
	COMPUTATION_VOLTAGE_TO_DIGITAL_8BITS( VDD_APPLI * 8 / (WAVEFORM_TEST_SAMPLES_NUMBER - 1)),
	COMPUTATION_VOLTAGE_TO_DIGITAL_8BITS( VDD_APPLI * 9 / (WAVEFORM_TEST_SAMPLES_NUMBER - 1)),
