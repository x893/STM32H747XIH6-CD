...
#define HBP             1
#define HFP             1
#define HACT            XSIZE_PHYS      /* !!!! SCREEN DIVIDED INTO 2 AREAS !!!! */
...
//  static RCC_PeriphCLKInitTypeDef  periph_clk_init_struct;
	...
	hltdc.Init.HorizontalSync = (LQ035NC111320x240_HSYNC - 1);
	hltdc.Init.VerticalSync = (LQ035NC111320x240_VSYNC - 1);
	hltdc.Init.AccumulatedHBP = (LQ035NC111320x240_HSYNC + LQ035NC111320x240_HBP - 1);
	hltdc.Init.AccumulatedVBP = (LQ035NC111320x240_VSYNC + LQ035NC111320x240_VBP - 1);  
	hltdc.Init.AccumulatedActiveH = (LQ035NC111320x240_HEIGHT + LQ035NC111320x240_VSYNC + LQ035NC111320x240_VBP - 1);
	hltdc.Init.AccumulatedActiveW = (LQ035NC111320x240_WIDTH + LQ035NC111320x240_HSYNC + LQ035NC111320x240_HBP - 1);
	hltdc.Init.TotalHeigh = (LQ035NC111320x240_HEIGHT + LQ035NC111320x240_VSYNC + LQ035NC111320x240_VBP + LQ035NC111320x240_VFP - 1);
	hltdc.Init.TotalWidth = (LQ035NC111320x240_WIDTH + LQ035NC111320x240_HSYNC + LQ035NC111320x240_HBP + LQ035NC111320x240_HFP - 1);
	...
	hltdc.Init.DEPolarity = LTDC_DEPOLARITY_AH; //Only 3.5 inch LCD is Hight polarity 
#endif
#ifdef USE_480x272
...
//  periph_clk_init_struct.PLL3.PLL3N = 288;
//  periph_clk_init_struct.PLL3.PLL3P = 2;
//  periph_clk_init_struct.PLL3.PLL3Q = 6;
//  periph_clk_init_struct.PLL3.PLL3R = 15;
	/* LCD clock configuration */
...
//  periph_clk_init_struct.PLL3.PLL3P = 1;
...
//  HAL_RCCEx_PeriphCLKConfig(&periph_clk_init_struct);
	...
	/* The 800x480 LCD is selected */
	/* Timing Configuration */    
	hltdc.Init.HorizontalSync = (G104AGE_HSYNC - 1);
	hltdc.Init.VerticalSync = (G104AGE_VSYNC - 1);
	hltdc.Init.AccumulatedHBP = (G104AGE_HSYNC + G104AGE_HBP - 1);
	hltdc.Init.AccumulatedVBP = (G104AGE_VSYNC + G104AGE_VBP - 1);  
	hltdc.Init.AccumulatedActiveH = (G104AGE_HEIGHT + G104AGE_VSYNC + G104AGE_VBP - 1);
	hltdc.Init.AccumulatedActiveW = (G104AGE_WIDTH + G104AGE_HSYNC + G104AGE_HBP - 1);
	hltdc.Init.TotalHeigh = (G104AGE_HEIGHT + G104AGE_VSYNC + G104AGE_VBP + G104AGE_VFP - 1);
	hltdc.Init.TotalWidth = (G104AGE_WIDTH + G104AGE_HSYNC + G104AGE_HBP + G104AGE_HFP - 1);
	...
	/* Timing Configuration */    
	hltdc.Init.HorizontalSync = (N101L6_HSYNC - 1);
	hltdc.Init.VerticalSync = (N101L6_VSYNC - 1);
	hltdc.Init.AccumulatedHBP = (N101L6_HSYNC + N101L6_HBP - 1);
	hltdc.Init.AccumulatedVBP = (N101L6_VSYNC + N101L6_VBP - 1);  
	hltdc.Init.AccumulatedActiveH = (N101L6_HEIGHT + N101L6_VSYNC + N101L6_VBP - 1);
	hltdc.Init.AccumulatedActiveW = (N101L6_WIDTH + N101L6_HSYNC + N101L6_HBP - 1);
	hltdc.Init.TotalHeigh = (N101L6_HEIGHT + N101L6_VSYNC + N101L6_VBP + N101L6_VFP - 1);
	hltdc.Init.TotalWidth = (N101L6_WIDTH + N101L6_HSYNC + N101L6_HBP + N101L6_HFP - 1);
	...
	/* Timing Configuration */    
	hltdc.Init.HorizontalSync = (HT21X21_HSYNC - 1);
	hltdc.Init.VerticalSync = (HT21X21_VSYNC - 1);
	hltdc.Init.AccumulatedHBP = (HT21X21_HSYNC + HT21X21_HBP - 1);
	hltdc.Init.AccumulatedVBP = (HT21X21_VSYNC + HT21X21_VBP - 1);  
	hltdc.Init.AccumulatedActiveH = (HT21X21_HEIGHT + HT21X21_VSYNC + HT21X21_VBP - 1);
	hltdc.Init.AccumulatedActiveW = (HT21X21_WIDTH + HT21X21_HSYNC + HT21X21_HBP - 1);
	hltdc.Init.TotalHeigh = (HT21X21_HEIGHT + HT21X21_VSYNC + HT21X21_VBP + HT21X21_VFP - 1);
	hltdc.Init.TotalWidth = (HT21X21_WIDTH + HT21X21_HSYNC + HT21X21_HBP + HT21X21_HFP - 1);
	...
	DMA2D_Handle.Init.ColorMode    = DMA2D_INPUT_RGB565;
	DMA2D_Handle.Init.OutputOffset = 0x0;     
	...
	/* Configure the DMA2D default mode */ 
//  DMA2D_Handle.Init.Mode         = DMA2D_R2M;
//  DMA2D_Handle.Init.ColorMode    = DMA2D_INPUT_ARGB8888;
//  DMA2D_Handle.Init.OutputOffset = 0x0;     
