...
static void _AnimationDemo(void) 
{
  ...
  DogData.xSize = 800;//LCD_GetXSize();
  DogData.ySize = 480;//LCD_GetYSize();
  ...
  CloudData.xSize = 800;//LCD_GetXSize();
  CloudData.ySize = 480;//LCD_GetYSize();
  ...
  BalloonData.xSize = 800;//LCD_GetXSize();
  BalloonData.ySize = 480;//LCD_GetYSize();
